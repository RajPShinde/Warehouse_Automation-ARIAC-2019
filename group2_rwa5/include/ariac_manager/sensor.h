...
//    ros::Subscriber quality_control_camera_subscriber_;
    ...
    std::string logical1_,logical2_,logical3_,logical4_,logical5_,logical6_,logical7_,logical8_;
    int camera1_frame_counter_, camera2_frame_counter_, camera3_frame_counter_, camera4_frame_counter_,camera5_frame_counter_,camera6_frame_counter_,camera7_frame_counter_,break_beam_counter_1_,break_beam_counter_2_,prev1,prev2,prev3,prev4,prev5,prev6,prev7,f;
};
